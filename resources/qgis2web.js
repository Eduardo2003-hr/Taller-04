...
map.getView().fit([-10112354.973913, -2132430.542912, -6583398.982561, 46665.777788], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DEPARTAMENTOS DEL PERÚ</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (20 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@eduardo huaripata.r';
            }
